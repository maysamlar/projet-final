...
export const getcommande = createAsyncThunk("commande/get", async (req, res) => {
  try {
    let result = axios.get("http://localhost:5005/commande/");
    return result;
  } catch (error) {
    console.log(error);
  }
...
export const addcommande = createAsyncThunk("commande/add", async (newcommande) => {
  try {
    let result = axios.post("http://localhost:5005/commande/add", newcommande);
    return result;
  } catch (error) {
    console.log(error);
  }
...
export const deletecommande = createAsyncThunk("commande/delete", async (id) => {
  try {
    let result = axios.delete(`http://localhost:5005/commande/${id}`);
    return result;
  } catch (error) {
    console.log(error);
  }
...
export const editcommande = createAsyncThunk("commande/edit", async ({ id, edit }) => {
  try {
    let result = axios.put(`http://localhost:5005/commande/${id}`, edit);
    return result;
  } catch (error) {
    console.log(error);
  }
